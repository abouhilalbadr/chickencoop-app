...
<template>
  <div v-if="loadingPrint" class="flex justify-center items-center fixed top-0 left-0 w-full h-full z-50" role="status">
    ...
    <svg aria-hidden="true" class="w-8 h-8 text-gray animate-spin fill-main relative" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col gap-4 mt-8 max-h-64 h-64 overflow-scroll">
      ...
      >
        <div class="flex items-center gap-3">
          <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><polyline points="6 9 6 2 18 2 18 9"></polyline><path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path><rect x="6" y="14" width="12" height="8"></rect></svg>
          <span>La commande N&#186; <span class="text-black font-bold">{{ item.bipeur }}</span> est prête à imprimer</span>
        </div>
      </button>
    </div>
